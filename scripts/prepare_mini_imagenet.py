...
# shutil.rmtree(DATA_PATH + '/miniImageNet/images_background')
# shutil.rmtree(DATA_PATH + '/miniImageNet/images_evaluation')
# os.mkdir(DATA_PATH + '/miniImageNet/images_background')
# os.mkdir(DATA_PATH + '/miniImageNet/images_evaluation')
